...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL VXXXXX(P(0,5),ZERO,+1,+1*IC(5),W(1,5))  !  count 1
      CALL VXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,6))  !  count 1
      CALL VXXXXX(P(0,6),ZERO,+1,+1*IC(6),W(1,7))  !  count 1
      CALL VXXXXX(P(0,6),ZERO,-1,+1*IC(6),W(1,8))  !  count 1
      CALL VVS4_3(W(1,5),W(1,7),GC_1,MDL_MH,FK_MDL_WH,W(1,9))  !  count 3
      CALL VVS4_3(W(1,6),W(1,8),GC_1,MDL_MH,FK_MDL_WH,W(1,10))  !  count 3
      CALL FFV2_3(W(1,1),W(1,4),GC_145,MDL_MW,ZERO,W(1,11))  !  count 6
      CALL FFV2_3(W(1,2),W(1,3),GC_62,MDL_MW,ZERO,W(1,12))  !  count 6
      CALL VVS2_4_6P1N_3(W(1,11), W(1,12), GC_93, GC_92, GC_94, TMP(1))
      call CombineAmpS(2, 
     &(/2,1/), 
     & (/9,10/), 
     & TMP, W, AMP(1,1))  !  count 1
      CALL VVS3P1N_3(W(1,11), W(1,12), GC_91, TMP(1))
      call CombineAmpS(2, 
     &(/2,1/), 
     & (/9,10/), 
     & TMP, W, AMP(1,2))  !  count 1
      CALL VVS3P1N_3(W(1,11), W(1,12), GC_117, TMP(1))
      call CombineAmpS(2, 
     &(/2,1/), 
     & (/9,10/), 
