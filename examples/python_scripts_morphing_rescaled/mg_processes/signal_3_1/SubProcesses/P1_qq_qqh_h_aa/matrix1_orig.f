...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WW)
      ...
      CALL VVS4_3(W(1,5),W(1,6),GC_1,MDL_MH, FK_MDL_WH,W(1,7))
      CALL FFV2_3(W(1,1),W(1,4),GC_145,MDL_MW, ZERO,W(1,6))
      CALL FFV2_3(W(1,2),W(1,3),GC_62,MDL_MW, ZERO,W(1,4))
C     Amplitude(s) for diagram number 1
      CALL VVS2_4_6_0(W(1,6),W(1,4),W(1,7),GC_93,GC_92,GC_94,AMP(1))
C     Amplitude(s) for diagram number 2
      CALL VVS3_0(W(1,6),W(1,4),W(1,7),GC_91,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL VVS3_0(W(1,6),W(1,4),W(1,7),GC_117,AMP(3))
